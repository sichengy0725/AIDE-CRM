## ============================================================
## AIDE-CRM helper with four CRM backends
##   1) fixed      : discount CRM with fixed r through JAGS
##   2) random     : discount CRM with random r through JAGS
##   3) alpha_crm  : deterministic alpha-CRM using alpha grid + integrate()
##   4) cumu_crm   : logistic cumulative-dose CRM through JAGS
##
...
crm_fit <- function(dat,
                    ...
                    target = 0.30,
                    cutoff = 0.95,
                    r_model = c("fixed", "random", "alpha_crm", "cumu_crm"),
                    r_carry = 0.10,
                    a_r = 1,
                    b_r = 9,
                    alpha_sd = 2,
